...
public class PopulationOfCollegeForBotany extends BaseClass implements PGCAFData
{
	XSSFWorkbook wb;
	XSSFSheet sht;
	String sheetName = "Botany(M,F)";
	...
	public void populationOfCollegeForEducationSubject() throws InterruptedException, IOException
	{
		...
		Thread.sleep(2000);
		From.AddPreferencePGSubject("BOTANY");
		Thread.sleep(2000);
		...
		XSSFSheet mySheet = myWorkBook.getSheet("Botany(M,F)");
