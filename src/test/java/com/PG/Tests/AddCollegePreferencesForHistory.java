...
public class AddCollegePreferencesForHistory extends BaseClass implements PGCAFData
{
	XSSFWorkbook wb;
	XSSFSheet sht;
	String sheetName = "AddCollege_History";
	...
	public void CheckForAddMoreThan10Colleges() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		From.AddPreferencePGSubject("HISTORY");
		Thread.sleep(2000);
	...
	public void CheckForAddWomenCollegeForMaleCandidate() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		From.SelectAddCollegeNameforOption("Sashi Bhusan Rath Government Women's College, Berhampur");
		From.ADD().click();
		Thread.sleep(2000);
