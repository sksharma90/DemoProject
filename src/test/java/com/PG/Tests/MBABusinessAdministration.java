...
public class MBABusinessAdministration extends BaseClass implements PGCAFData {
	...
	@Test(priority = 1)
	public void MBABusinessAdministrationWithAtleast50Percentage() throws Exception {

		// logger = report.createTest("Verify MBA Business Administration Apply Atleast
		// 50 Percentage");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent().info("Selecting MBA (Business Admistration)");
			Thread.sleep(400);
			Thread.sleep(400);
			...
			ExtentFactory.getInstance().getExtent()
					.info("Successfully Checked MBABusinessAdministration Pg Department Atleast 50 Percentage");
		}

	}

	@Test(priority = 2)
	public void MBABusinessAdministrationWithLessThan50Percentage() throws Exception {

		// logger = report.createTest("Verify MBA Business Administration with Less Than
		// 50 Percentage");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent().info("Selecting MBABusinessAdministration");
			Thread.sleep(400);
			Thread.sleep(400);
			From.PGSubjectofAdmission("MBA (Business Admistration)");
			...
			ExtentFactory.getInstance().getExtent()
					.info("Successfully Checked MBABusinessAdministration PG Department with Less Than 50 Percentage");
		}
