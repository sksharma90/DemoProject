...
public class MassCommunicationAndMediaTechnology extends BaseClass implements PGCAFData{
	...
	@Test(priority = 1)
	public void MassMediaWithAtleast45percentage() throws InterruptedException {

		//logger = report.createTest("Verifying Mass Media PG Department Apply Minimum 45 Percentage");
		...
		String[] arrData = { "Arts", "Commerce", "Science", "BTech", "BE", "B Pharma" };
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent().info("Selecting Mass Communication and Media Technology");
			Thread.sleep(400);
			From.PGSubjectofAdmission("Mass Communication and Media Technology");
			...
			Thread.sleep(400);
			From.FirstPreference("Khallikote University, Berhampur");
			Thread.sleep(400);
			...
			ExtentFactory.getInstance().getExtent().info("Successfully Checked Mass Media Department Apply Minimum 45 percentage Scenario");
		}

	}

	@Test(priority = 2)
	public void MassMediaWithLessThan45percentage() throws Exception {

		//logger = report.createTest("Verifying Mass Media Department with Less Than 45 Percenatge");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent()
					.info("Successfully Checked Mass Media Department with Less Than 45 Percenatge Scenario");
		}
