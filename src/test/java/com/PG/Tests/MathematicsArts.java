...
public class MathematicsArts extends BaseClass implements PGCAFData {
	...
	public void MathmaticsWithAtleast45percentage() throws Exception {
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent().info("Selecting Mathematics(Arts)");
			Thread.sleep(400);
			From.PGSubjectofAdmission("Mathematics(Arts)");
