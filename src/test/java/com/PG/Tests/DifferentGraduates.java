...
public class DifferentGraduates extends BaseClass implements PGCAFData{
	...
	@Test(priority = 1)
	public void ApplyingByDifferentTypeOfGraduates() throws Exception {

		//logger = report.createTest("Verifying Applying Different Type Of Graduates");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent()
					.info("Successfully Checked Applying Different Type Of Graduates scenario");
		}
