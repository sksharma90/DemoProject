...
public class LibraryScienceDepartment extends BaseClass implements PGCAFData{
	...
	@Test(priority = 1)
	public void LibraryScienceWithAtleast45percentage() throws Exception {

		//logger = report.createTest("Verifying LibraryScience PG Department Apply Minimum 45 Percentage");
		...
		Thread.sleep(500);
		String[] arrData = { "B.Lib and Information Science" };
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			if (defaultItem.equals("B.Lib and Information Science")) {
				From.CoreorHons("Library Science");
			}

			ExtentFactory.getInstance().getExtent().info("Selecting Library and Information Science");
			...
			ExtentFactory.getInstance().getExtent().info("Successfully Checked LibraryScience Department Apply Minimum 45 percentage Scenario");
		}

	}

	@Test(priority = 2)
	public void LibraryScienceWithLessThan45percentage() throws Exception {

		//logger = report.createTest("Verifying LibraryScience Department Not Apply Less Than 45 Percenatge");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent()
					.info("Successfully Checked LibraryScience Department Not Apply Less Than 45 Percenatge Scenario");
		}
