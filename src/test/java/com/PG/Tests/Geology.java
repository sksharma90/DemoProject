...
public class Geology extends BaseClass implements PGCAFData {
	...
	@Test(priority = 1)
	public void GeologyWithAtleast45percentage() throws Exception {

		// logger = report.createTest("Verifying Geology PG Department Apply Minimum 45
		// Percentage");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent().info("Geology");
			Thread.sleep(400);
			From.PGSubjectofAdmission("Geology");
			...
			ExtentFactory.getInstance().getExtent()
					.info("Successfully Checked Geology Department Apply Minimum 45 percentage Scenario");
		}

	}

	@Test(priority = 2)
	public void GeologyWithLessThan45percentage() throws Exception {

		// logger = report.createTest("Verifying Geology Department Not Apply Less Than
		// 45 Percenatge");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent()
					.info("Successfully Checked Geology Department Not Apply Less Than 45 Percenatge Scenario");
		}
