...
public class PopulationOfCollegeForZoology extends BaseClass implements PGCAFData
{
	XSSFWorkbook wb;
	XSSFSheet sht;
	String sheetName = "Zoology(M,F)";
	...
	public void populationOfCollegeForEducationSubject() throws InterruptedException, IOException
	{
		...
		Thread.sleep(2000);
		From.AddPreferencePGSubject("ZOOLOGY");
		Thread.sleep(2000);
		...
		XSSFSheet mySheet = myWorkBook.getSheet("Zoology(M,F)");
