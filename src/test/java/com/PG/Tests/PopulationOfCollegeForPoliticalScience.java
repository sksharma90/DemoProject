...
public class PopulationOfCollegeForPoliticalScience extends BaseClass implements PGCAFData
{
	XSSFWorkbook wb;
	XSSFSheet sht;
	String sheetName = "PoliticalScience(M,F)";
	...
	public void populationOfCollegeForEducationSubject() throws InterruptedException, IOException
	{
		...
		Thread.sleep(2000);
		From.AddPreferencePGSubject("POLITICAL SCIENCE");
		Thread.sleep(2000);
		...
		XSSFSheet mySheet = myWorkBook.getSheet("PoliticalScience(M,F)");
