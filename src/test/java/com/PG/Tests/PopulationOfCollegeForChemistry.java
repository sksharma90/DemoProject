...
public class PopulationOfCollegeForChemistry extends BaseClass implements PGCAFData
{
	XSSFWorkbook wb;
	XSSFSheet sht;
	String sheetName = "Chemistry(M,F)";
	...
	public void populationOfCollegeForEducationSubject() throws InterruptedException, IOException
	{
		...
		Thread.sleep(2000);
		From.AddPreferencePGSubject("CHEMISTRY");
		Thread.sleep(2000);
		...
		XSSFSheet mySheet = myWorkBook.getSheet("Chemistry(M,F)");
