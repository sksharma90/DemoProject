...
public class HaveYouPassedGraduationWithDistinction extends BaseClass implements PGCAFData {
	...
	@Test(priority = 1)
	public void SelectionofHaveYouPassedGraduationWithDistinction() throws Exception {

		// logger = report.createTest("Verify the selection of Have You Passed
		...
		Thread.sleep(500);
		ExtentFactory.getInstance().getExtent().info("Select Graduation With Distinction");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent()
					.info("Successfully Checked English Department Apply Minimum 45 percentage Scenario");
		}
