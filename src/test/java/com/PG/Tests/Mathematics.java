...
public class Mathematics extends BaseClass implements PGCAFData {
	...
	public void MathmaticsWithAtleast45percentage() throws Exception {
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent().info("Selecting MathMatics");
			Thread.sleep(400);
			From.PGSubjectofAdmission("Mathematics");
