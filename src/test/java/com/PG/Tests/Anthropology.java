...
public class Anthropology extends BaseClass implements PGCAFData {
	...
	@Test(priority = 1)
	public void AnthropologyWithAtleast45Percentage() throws Exception {
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			if (defaultItem.equals("Arts")) {
				...
				String[] arrData1 = { "Anthropology(Arts)", "Geography(Arts)", "Psychology", "Sociology",
				...
				for (int j = 0; j < arrData1.length; j++) {
					...
					ExtentFactory.getInstance().getExtent().info("Selecting Anthropology");
					Thread.sleep(400);
					From.PGSubjectofAdmission("Anthropology");
				...
				String[] arrData1 = { "Zoology", "Microbiology", "Geology", "Biotechnology", "Botany",
				...
				for (int j = 0; j < arrData1.length; j++) {
					...
					Thread.sleep(500);
					From.GraduationStream("Commerce");
	...
	@Test(priority = 2)
	public void AnthropologyWithLessThan45Percentage() throws InterruptedException {
