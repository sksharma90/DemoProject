...
public class MBAFinancialManagement extends BaseClass implements PGCAFData{
	...
	@Test(priority = 1)
	public void MBAFinancialManagementWithAtleast50Percentage() throws Exception {

		//logger = report.createTest("Verify MBA Financial Management Apply Atleast 50 Percentage");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent().info("Selecting MBA (Financial Management)");
			Thread.sleep(400);
			From.PGSubjectofAdmission("MBA (Financial Management)");
			...
			ExtentFactory.getInstance().getExtent().info("Successfully Checked MBAFinancialManagement Pg Department Atleast 50 Percentage");
		}

	}

	@Test(priority = 2)
	public void MBAFinancialManagementLessThan50Percentage() throws Exception {

		//logger = report.createTest("Verify MBA Financial Management with Less Than 50 Percentage");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent().info("Selecting MBAFinancialManagement");
			Thread.sleep(400);
			Thread.sleep(400);
			From.PGSubjectofAdmission("MBA (Financial Management)");
			...
			ExtentFactory.getInstance().getExtent().info("Successfully Checked MBAFinancialManagement PG Department Not Apply Less Than 50 Percentage scenario");
		}
