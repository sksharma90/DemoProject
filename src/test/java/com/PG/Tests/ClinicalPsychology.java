...
public class ClinicalPsychology extends BaseClass implements PGCAFData {
	...
	@Test(priority = 1)
	public void ClinicalPsychologyWithAtleast45Percentage() throws Exception {

		// logger = report.createTest("Verify Clinical Psychology with Atleast 45
		// Percentage");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent().info("Selecting Clinical Psychology");
			Thread.sleep(400);
			From.PGSubjectofAdmission("Clinical Psychology");
			...
			ExtentFactory.getInstance().getExtent()
					.info("Successfully Checked ClinicalPsychology PG Department Atleast 45 Percentage scenario");
		}

	}

	@Test(priority = 2)
	public void ClinicalPsychologyWithLessThan45Percentage() throws Exception {

		// logger = report.createTest("Verify Clinical Psychology with Less Than 45
		// Percentage");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent().info(
					"Successfully Checked ClinicalPsychology Pg Department with Less Than 45 Percentage scenario");
		}
