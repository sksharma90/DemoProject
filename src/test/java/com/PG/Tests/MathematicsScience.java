...
public class MathematicsScience extends BaseClass implements PGCAFData {
	...
	@Test(priority = 1)
	public void MathmaticsWithAtleast45percentage() throws Exception {

		// logger = report.createTest("Verifying MathMatics PG Department Apply Minimum
		// 45 Percentage");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent().info("Selecting MathMatics(Science)");
			Thread.sleep(400);
			From.PGSubjectofAdmission("Mathematics(Science)");
			...
			ExtentFactory.getInstance().getExtent()
					.info("Successfully Checked MathMatics Department Apply Minimum 45 percentage Scenario");
		}

	}

	@Test(priority = 2)
	public void MathWithLessThan45percentage() throws Exception {

		// logger = report.createTest("Verifying MathMatics Department with Less Than 45
		// Percenatge");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent().info("Selecting Mathematics(Science)");
			Thread.sleep(400);
			From.PGSubjectofAdmission("Mathematics(Science)");
			...
			ExtentFactory.getInstance().getExtent()
					.info("Successfully Checked MathMatics Department with Less Than 45 Percenatge Scenario");
		}
