...
public class PoliticalScience extends BaseClass implements PGCAFData{
	...
	@Test(priority = 1)
	public void PoliticalScienceWithAtleast45percentage() throws Exception {

		//logger = report.createTest("Verifying PoliticalScience PG Department Apply Minimum 45 Percentage");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent().info("Selecting Political Science");
			Thread.sleep(400);
			...
			ExtentFactory.getInstance().getExtent().info("Successfully Checked Linguistics Department Apply Minimum 45 percentage Scenario");
		}

	}

	@Test(priority = 2)
	public void PoliticalScienceWithLessThan45percentage() throws Exception {

		//logger = report.createTest("Verifying PoliticalScience Department Not Apply Less Than 45 Percentage");
		...
		for (int i = 0; i < arrData.length; i++) {
			...
			ExtentFactory.getInstance().getExtent()
					.info("Successfully Checked Linguistics Department Not Apply Less Than 45 Percentage Scenario");
		}
